...
description: "Verification loop for Django: migrations, linting, tests with coverage, security scans, and deployment readiness. Use during review before Django releases or PRs."
user-invocable: true
---
...
### Phase Guidance
**In review**: Run full verification loop: check migrations, run linter, execute tests with coverage, scan for security issues, verify deployment readiness.
