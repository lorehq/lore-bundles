...
description: "Decision framework for choosing regex vs LLM for structured text parsing. Use during design when planning text extraction approach, and implement when building parsers."
user-invocable: true
---
...
### Phase Guidance
**In design**: Use decision framework to choose parsing approach during architecture. Start with regex for structured patterns, reserve LLM for edge cases.
**In implement**: Apply the chosen strategy during parser implementation. Build hybrid pipeline if needed.
