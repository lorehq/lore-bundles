...
description: "Strategic context compaction for long sessions. Use during design for multi-phase sessions approaching context limits, suggesting /compact at logical breakpoints."
user-invocable: true
---
...
### Phase Guidance
**In design**: Suggest compaction between major phases (research to plan, plan to implement). Preserve critical decisions across compaction boundaries.
