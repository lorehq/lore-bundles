...
description: "Verification loop for Spring Boot: build, static analysis, tests with coverage, security scans, and diff review. Use during review before Spring Boot releases or PRs."
user-invocable: true
---
...
### Phase Guidance
**In review**: Run full verification loop: build check, static analysis, test suite with coverage, security scan, and diff review.
