...
description: "Protocol-based dependency injection for testable Swift code with mock strategies and Swift Testing. Use during implement when writing testable Swift with DI."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply protocol-based DI during Red and Green phases. Define protocols for dependencies, inject via init, create mocks for testing.
