---
name: configure-ecc
description: "Interactive installer for Everything Claude Code skills and rules. Use during setup or project initialization to install and configure ECC skills."
user-invocable: true
---
...
### Phase Guidance
**In cross-cutting**: Use during project setup to install and configure relevant skills. Guides through skill selection and path configuration.
