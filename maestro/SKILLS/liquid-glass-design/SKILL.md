...
description: "iOS 26 Liquid Glass design system with dynamic glass materials, blur, reflection, and interactive morphing. Use during implement when building iOS 26 UI with the glass material system."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply Liquid Glass patterns when implementing iOS 26 UI. Use GlassEffectContainer, dynamic tinting, and morphing animations per Apple HIG.
