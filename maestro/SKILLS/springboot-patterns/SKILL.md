...
description: "Spring Boot architecture patterns, REST API design, layered services, and caching. Use during implement when building Java Spring Boot backend services."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply Spring Boot patterns during service implementation. Use layered architecture, proper exception handling, and Spring conventions.
