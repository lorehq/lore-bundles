...
description: "Apple FoundationModels framework for on-device LLM with guided generation and tool calling in iOS 26+. Use during implement when building on-device ML features for Apple platforms."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply FoundationModels patterns when implementing on-device LLM features. Use @Generable for structured output and snapshot streaming for UI.
