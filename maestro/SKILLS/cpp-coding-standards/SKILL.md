...
description: "C++ coding standards based on C++ Core Guidelines for modern, safe, idiomatic C++. Use during implement for C++ code quality and review for C++ review criteria."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply C++ Core Guidelines during implementation. Enforce RAII, smart pointers, const correctness, and modern C++ idioms.
**In review**: Use as review checklist for C++ safety, resource management, and adherence to Core Guidelines.
