...
description: "Thread-safe data persistence using Swift actors with in-memory cache and file-backed storage. Use during implement when building persistence layers in Swift."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply actor-based persistence when implementing data storage. Use actors to eliminate data races by design with file-backed caching.
