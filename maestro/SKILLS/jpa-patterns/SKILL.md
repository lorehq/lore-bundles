---
name: jpa-patterns
description: "JPA/Hibernate patterns for entity design, relationships, query optimization, and transactions in Spring Boot. Use during implement when building JPA entities or optimizing database access."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply JPA patterns when implementing entity relationships, custom queries, and transaction management. Avoid N+1 queries with proper fetch strategies.
