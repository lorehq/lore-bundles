...
description: "Patterns for autonomous Claude Code loops from simple pipelines to multi-agent DAG systems. Use during design when architecting automated workflows or multi-agent orchestration."
user-invocable: true
---
...
### Phase Guidance
**In design**: Reference loop architecture patterns when designing autonomous workflows. Choose appropriate complexity level (sequential, parallel, DAG) during architecture decisions.
