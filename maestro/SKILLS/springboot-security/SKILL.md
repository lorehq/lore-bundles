...
description: "Spring Security best practices for authentication, authorization, CSRF, secrets, and rate limiting. Use during review when reviewing Spring Boot security configuration."
user-invocable: true
---
...
### Phase Guidance
**In review**: Apply Spring Security checklist during review. Verify authentication config, authorization rules, CSRF protection, and dependency security.
