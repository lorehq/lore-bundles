---
name: search-first
description: "Research-before-coding workflow. Use during design to find existing tools, libraries, and patterns before writing custom code."
user-invocable: true
---
...
### Phase Guidance
**In design**: Search for existing solutions before designing custom implementations. Check package registries, GitHub, and documentation first.
