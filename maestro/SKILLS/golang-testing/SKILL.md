---
name: golang-testing
description: "Go testing with table-driven tests, subtests, benchmarks, and fuzzing. Use during implement when writing Go tests following TDD methodology."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply during Red phase (Step 6a.2) for Go tests. Use table-driven tests, subtests for organization, and benchmarks for performance-critical code.
