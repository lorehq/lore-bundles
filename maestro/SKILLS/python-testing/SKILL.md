---
name: python-testing
description: "Python testing with pytest, TDD methodology, fixtures, mocking, and parametrization. Use during implement when writing Python tests following TDD."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply during Red phase (Step 6a.2) for Python tests. Use pytest fixtures, parametrize for edge cases, and mock external dependencies.
