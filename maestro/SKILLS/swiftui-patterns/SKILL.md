...
description: "SwiftUI architecture with @Observable state management, view composition, navigation, and performance optimization. Use during implement when building SwiftUI views and features."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply SwiftUI patterns during UI implementation. Use @Observable for state, proper view composition, and navigation patterns.
