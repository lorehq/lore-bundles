...
description: "Nutrient DWS API for document processing, conversion, OCR, redaction, signing, and form filling. Use during implement when building document processing features with Nutrient."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply Nutrient API patterns when implementing document workflows. Use appropriate endpoints for conversion, OCR, redaction, or signing tasks.
