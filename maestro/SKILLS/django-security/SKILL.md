...
description: "Django security best practices for authentication, CSRF, SQL injection, XSS prevention, and secure deployment. Use during review when reviewing Django security posture."
user-invocable: true
---
...
### Phase Guidance
**In review**: Apply security checklist during review phase. Verify CSRF protection, SQL injection prevention, XSS defenses, and authentication configuration.
