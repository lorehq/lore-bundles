---
name: django-tdd
description: "Django TDD with pytest-django, factory_boy, and DRF testing. Use during implement when writing tests for Django models, views, and API endpoints."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply during Red phase (Step 6a.2) for Django test writing. Use factory_boy for fixtures, pytest-django for test runner, and DRF test client for API tests.
