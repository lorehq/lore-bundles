---
name: cpp-testing
description: "C++ testing with GoogleTest and CTest, coverage analysis, and sanitizers. Use during implement when writing C++ tests and review when checking C++ test coverage."
user-invocable: true
---
...
### Phase Guidance
**In implement**: Apply during Red phase for C++ tests. Use GoogleTest assertions, TYPED_TEST for generic code, and CTest for integration.
**In review**: Verify test coverage with gcov/lcov. Check sanitizer configurations and test organization during review.
