...
description: "Example project-specific skill template based on a real production application. Use during setup as a reference for creating custom project skills."
user-invocable: true
---
...
### Phase Guidance
**In cross-cutting**: Reference as a template when creating project-specific skills during setup. Shows structure and conventions for custom skills.
