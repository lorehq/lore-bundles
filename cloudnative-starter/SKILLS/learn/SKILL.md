...
Run this at any point during a session when you've solved a non-trivial problem.
...
Focus on patterns that will save time in future sessions. Keep skills focused -- one pattern per skill.
