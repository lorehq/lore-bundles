---
description: Security rules covering prompt injection defense, credential protection, MCP server safety, and incident response
---
...
- Never enable all project MCP servers without review
- Verify MCP server source code before approval
- Use user scope for trusted servers only
