...
> Addresses the cognitive failure mode of **black-box reasoning** -- the agent gives an answer but the user cannot see what assumptions were relied on, what alternatives were rejected, or which part of the reasoning is weakest.
